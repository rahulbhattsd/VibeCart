...
//   if (!items.length) return <p>Your cart is empty. <Link to="/">Shop now</Link></p>;

//   return (
//     <div className="cart-page">
//       <h2>Your Cart</h2>
//       <button className="btn btn-secondary clear-btn" onClick={clearCart}>Clear Cart</button>

//       <ul className="cart-list">
//         {items.map(i => (
//           <li key={i._id}>
//             <Link to={`/purchase/${i.listing._id}`}>
//               <img src={i.listing.imageUrl} alt={i.listing.title} loading="lazy" />
//             </Link>
//             <div className="cart-item-details">
//               <Link to={`/purchase/${i.listing._id}`} className="cart-item-title">
//                 {i.listing.title}
//               </Link>
//               <span className="cart-item-price">₹{i.listing.price}</span>
//               <input
//                 type="number"
//                 value={i.quantity}
//                 min="1"
//                 max={i.listing.inventory[i.size]}
//                 onChange={e => updateQty(i._id, Number(e.target.value))}
//               />
//             </div>
//             <button className="btn btn-secondary remove-btn" onClick={() => removeItem(i._id)}>
//               Remove
//             </button>
//           </li>
//         ))}
...
//         {payMethod === 'COD' ? 'Place COD Order' : 'Pay with Razorpay'}
//       </button>
//     </div>
//   );
// };
